...
{
    /// <summary>   Abstract base implementation for adapters used to automatically sign packages after they are pushed to a feed. </summary>
    public abstract class SignPackageAfterPushAdapter : AfterPushPackageAdapter
    {
        ...
        public sealed override Stream Adapt( PackageAdapterContext packageInfo )
        {
            ...
            Logger.Warning( $"Skipping sign after push as the [{packageInfo.Feed.FeedName}|{packageInfo.Feed.FeedType}] is not supported by this signer [{this.GetType( ).Name}]." );
