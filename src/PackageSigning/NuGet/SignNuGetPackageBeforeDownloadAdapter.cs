...
{
    /// <summary>   Used to automatically sign NuGet pacakges before they are downloaded from the feed. </summary>
    [DisplayName( "Sign NuGet packages before downloaded" )]
    [Description( "Automatically signs NuGet packages before they are downloaded from the feed." )]
    public class SignNuGetPackageBeforeDownloadAdapter : SignPackageBeforeDownloadAdapter
    {
        #region Overrides of SignPackageBeforeDownloadAdapter
